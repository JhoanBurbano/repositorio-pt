...
export const schema = yup.object({
    ...
    cc: yup.number().positive().integer('solo se aceptan numeros').min(8, 'debe tener minimo 8 numeros').max(10, 'debe contener maximo 10 digitos').required('Su documento de identidad es obligatorio'),
    ...
    email: yup.string().email('Formato invalido, debe seguir el template: email@dominio.com').length(20).required('El email es obligatorio')
  }).required();